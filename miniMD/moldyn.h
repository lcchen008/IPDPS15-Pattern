...
#      define MAXINTERACT       5000000    /* needs 49 for auto.graph */
# elif defined(EXTREME) 
#      define BOXSIZE                64	   /* create 1048576 molecules */
#      define MAXINTERACT      11944000
# elif defined(USERDEFINE)
#      define BOXSIZE                64 
#      define MAXINTERACT      140000000 
# endif     
