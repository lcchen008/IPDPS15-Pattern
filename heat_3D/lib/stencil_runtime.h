...
{
public:
	StencilRuntime(int num_dims, int unit_size, const IndexArray &global_size, int proc_num_dims, IntArray proc_size, int stencil_width, int num_iters, void *parameter, size_t parameter_size);
	...
	void *get_parameter(){return parameter_;}
